...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.5814,  21.5814 }
    #define DEFAULT_Ki_LIST {   1.7296,   1.7296 }
    #define DEFAULT_Kd_LIST { 67.3205, 67.3205 }
  #else
    #define DEFAULT_Kp  21.5814
    #define DEFAULT_Ki   1.7296
    #define DEFAULT_Kd 67.3205
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 797.86, 400 }
